  ...
  Examples:
    ...
    .. tabs::
       ...
       .. code-tab:: bash oiiotool
          ...
          # Add images A and B
          oiiotool grid.exr grid.exr --add -o add.exr

          # Add 0.2 to channels 0-2, but not to channel 3
          oiiotool grid.exr --addc 0.2,0.2,0.2,0.0 -o out.exr
  ...
  Examples:
    ...
    .. tabs::
       ...
       .. code-tab:: bash oiiotool
          ...
          oiiotool grid.exr grid.exr --sub -o out.exr
  ...
  Examples:
    ...
    .. tabs::
       ...
       .. code-tab:: bash oiiotool
          ...
          oiiotool grid.exr grid.exr --absdiff -o out.exr
  ...
  Examples:
    ...
    .. tabs::
       ...
       .. code-tab:: bash oiiotool
          ...
          oiiotool grid.exr --abs -o out.exr
